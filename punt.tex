...
\setmathfont[version=default,NFSSFamily=mathfont]{Libertinus Math}
\mathversion{default}
...
\draw[line width=1pt,->] (11.4,1.35) -- (12.4,1.35) node[anchor=north] {$\symbfit{v}$};
\end{tikzpicture}
\end{center}
...
\emph{Zut alors}, the lies confuse them and they can't unlock the treasure. Can you work out who is lying and claim the treasure for yourself?
...
$^\text{†}$In the same way that you might say the number 18 appears in 1018 or 2189.}
\end{minipage}
